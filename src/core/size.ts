 ...
 * it rather than over the card below. That behaviour is `_applyMinHeight` in
 * `base-card.ts`, and was the whole of why 4 rows used to look like the shortest a card
 * could be.
 *
